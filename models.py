...
class User(Base):
    ...
    Year_of_Study=Column(BigInteger,nullable=False)
    Register_Number=Column(BigInteger,primary_key=True)
    ...
    Annual_Income_of_Parent=Column(BigInteger,nullable=False)
